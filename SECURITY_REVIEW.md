...
`-trimpath` → removes the builder's absolute module/source paths from the compiled binary so `strings <binary>` doesn't reveal the builder's HOME. Also makes the build reproducible independent of the builder's filesystem layout.
...
**SHA-256 of each shipped binary:**

```
ee0f1f22df58f10bfdeb45ce35d3460ee8f5cf0545e1293b16592bc91fa05029  credential-process-linux-arm64
a648dacb3b4a0f5e712534d4e61fae1c6f25020f81b89b4c94ed752d2dae2535  credential-process-linux-x64
e2214ba61fc8176515100dcbdc4c601e3d5ca62806e777eff8af95018ba30dd7  credential-process-macos-arm64
684b55ffc766526faf77e1fd238f17a2e5de77b87a9aa8f2ea81e2cbc46db7a4  credential-process-macos-intel
0d6be053768d7a17692fe4d048085d1887223bc39ad1ad47dd7531f3a260221e  credential-process-windows.exe
216b1fee92c6f9f080122e703017f1a32ec63729f6be9bac522070832262c3ee  otel-helper-linux-arm64
f73698c0d73a2e2d8097561a62586e72ada60fa1a8ae272103bf9ed3a71dcbaf  otel-helper-linux-x64
e2683279a08687c9ee3eae9531aef3a7aba0c430fca37464fc782fc2d8a7babf  otel-helper-macos-arm64
d03140e28e80a3494b0b3cccb9316fc3a81dd4a09cc830e97213a0d80f1f5d39  otel-helper-macos-intel
36dcad8c7d78a78b7b3d56576b692ea7924f9eaf54cbd2103e639f4fa8eb9476  otel-helper-windows.exe
```
...
# Run syft from inside the prebuilt dir so the SBOM records only the binary
# name, not an absolute host path.
( cd prebuilt/v2.0.0 && \
    for bin in credential-process-* otel-helper-*; do
      syft "$bin" -o cyclonedx-json="../../../../security-review-artifacts/sbom/${bin}.cdx.json"
    done )
